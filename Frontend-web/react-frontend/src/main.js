...
fetch("http://localhost:3000/api/shifts/today/city/54")
  ...
  .then(res => {
    ...
    marker.bindPopup(
      '<div id="popup">' +
        '<h5>Pharamacy: <span id="pharamcyName">' +
        pharmacyName +
        "</span></h5>" +
        '<h5>State: <span id="pharamcyState">' +
        pharmacyState +
        "</span></h5>" +
        '<h5>City: <span id="pharamcyCity">' +
        pharmacyCity +
        "</span></h5>" +
        '<h5>Date: <span id="pharamcyDate">' +
        pharmacyDate +
        "</span></h5>" +
        '<img id="pharmacyImg" src="' +
        pharmacyImg +
        '">' +
        '<div id="navigationContainer">' +
        '<img id="navigationImg" src="./navigation.png">' +
        '<a id="pharamacyGoogleMapsLink" target="_blank" href="' +
        pharamacyGoogleMapsLink +
        '">Click to navigate using Google Maps</a>' +
        "</div>" +
        "</div>"
    );
  });
